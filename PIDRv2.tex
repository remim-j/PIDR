...
\begin{table}
	\begin{tabular}{|p{4cm}|p{4.5cm}|p{4.5cm}|}
		\hline
 & Friedkin et Johnson \cite{FJ} & Vande Kerckhove \cite{VMG} \tabularnewline
		\hline
