...
Nous avons donc confronté les deux modèles d'évolution de l'opinion d'un individu. Nous avons remarqué l'absence de l'opinion initiale dans le modèle proposé par Van de Kerckhove et al. \cite{VMG}. Nous avons donc pu utiliser les données obtenues par Van de Kerckhove et al. \cite{VMG} afin de vérifier le modèle de Friedkin et Johnson \cite{FJ}.\\
